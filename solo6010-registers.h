...
#define	  SOLO_OSG_ERASE_OFF			0

#define SOLO_VO_OSG_BLINK			0x03E8
#define	  SOLO_VO_OSG_BLINK_ON			2
 ...
 *	UART REGISTER
 */
#define SOLO_UART_CONTROL(n)			(0x0BA0 + (((n) & 1) << 5))
...
#define	  SOLO_BAUDRATE_230400			0
#define	  SOLO_BAUDRATE_115200			(1 << 6)
#define	  SOLO_BAUDRATE_57600			(2 << 6)
#define	  SOLO_BAUDRATE_38400			(3 << 6)
#define	  SOLO_BAUDRATE_19200			(4 << 6)
#define	  SOLO_BAUDRATE_9600			(5 << 6)
#define	  SOLO_BAUDRATE_4800			(6 << 6)
#define	  SOLO_BAUDRATE_2400			(016 << 6)
#define	  SOLO_BAUDRATE_1200			(026 << 6)
#define	  SOLO_BAUDRATE_300			(036 << 6)
...
#define	  SOLO_UART_PARITY_NONE			0
